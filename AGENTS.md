...
- Core tests: `tests/core/*` (covers `FPoint`, `FObject`, `FGameConfig`, `WXStrategicUITest` runtime-guard regression coverage for strategic adapter cancel/early-return behavior when no usable wx runtime exists, etc.)
