...
assertContains(body, "turnData->nMoved = 0;");
	...
	assertContains(body, "const int originalStartHeading = turnData->startHeading;");
	assertContains(body, "const int originalCurHeading = turnData->curHeading;");
	assertContains(body, "const int originalFinalHeading = turnData->finalHeading;");
	assertContains(body, "const int originalMoved = m_moved;");
	...
	assertContains(body, "if (*headingItr == turnData->curHeading) {");
	...
	assertContains(body, "turnData->curHeading = originalCurHeading;");
	assertContains(body, "turnData->finalHeading = originalFinalHeading;");
	assertContains(body, "turnData->nMoved = originalMoved;");
	assertContains(body, "turnData->path = originalPath;");
	assertContains(body, "m_moved = originalMoved;");
	assertContains(body, "computeRemainingMoves(m_shipPos);");
